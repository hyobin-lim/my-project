# 🧠 PROJECT FREEISM: SUPREME CORE PROTOCOL (V21.7 JURISDICTIONAL PRECISION)
...
3. **Mutual Restraint**: T1 and T2 must maintain objective distance and monitor each other based on their respective rulebooks.
...
3. **상호 견제**: T1과 T2는 각자의 매뉴얼에 명시된 규칙을 기반으로 거리를 두고 서로를 감시한다.
